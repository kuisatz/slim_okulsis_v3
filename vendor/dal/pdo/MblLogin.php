    ...
    public function kySubeOgrenciDersListesi($params = array()) { /// okiii 
        try {
            ...
            SELECT  
                ...
                PuanOrtalamasi ,
                COALESCE(NULLIF(Donem1_PuanOrtalamasi,NULL),'') as Donem1_PuanOrtalamasi,
                COALESCE(NULLIF(Donem2_PuanOrtalamasi,NULL),'') as Donem2_PuanOrtalamasi,
...
// http://localhost:8000/jasperserver/rest_v2/reports/reports/bilsa/ddd.html
             $report = $c->reportService()->runReport('/reports/bilsa/ddd', 'html');
